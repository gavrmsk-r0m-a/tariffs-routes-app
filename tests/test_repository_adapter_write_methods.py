...
class RepositoryAdapterWriteMethodsTest(unittest.TestCase):
    ...
    def test_stage54_dictionary_creates_use_postgres_returning_and_caller_commit_contract(self):
        ...
        self.assertEqual(repo.create_server("EU69A", None, commit=False), 91)
        ...
        self.assertIn("INSERT INTO servers(name, comment, is_active) VALUES (%s, %s, %s) RETURNING id", sql)
        ...
        self.assertEqual(conn.calls[4][1], ("EU69A", None, True))
...
class RepositoryStage65ACompanyRoutingTest(unittest.TestCase):
    ...
    def test_postgres_routing_setting_timestamp_uses_named_dict_value(self):
        ...
        class Conn:
            ...
            def execute(self, sql, params=()):
                self.calls.append((sql, params))
                if "CURRENT_TIMESTAMP AS value" in sql: return Cursor({"value": "2026-07-30 12:34:56+00"})
        ...
        self.assertEqual(insert_params[8], "2026-07-30 12:34:56+00")
