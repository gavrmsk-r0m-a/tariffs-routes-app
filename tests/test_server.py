...
class ServerSmokeTest(unittest.TestCase):
    ...
    def test_bulk_phone_validate_does_not_write_and_reports_row_errors(self):
        ...
        bulk_form_start = content.index("<form method='post' action='/phones/bulk-create'")
        bulk_form_end = content.index("</form>", bulk_form_start)
        self.assertGreater(content.index("<section class='card bulk-phone-result'"), bulk_form_end)
