...
class PostgreSQLRepositorySmokeTest(unittest.TestCase):
    ...
    def test_stage_48_methods_are_declared_once(self):
        ...
        self.assertEqual(1, smoke.SMOKE_METHODS.count("list_calling_company_events"))
        self.assertEqual(1, smoke.SMOKE_METHODS.count("count_calling_company_events"))
    ...
    def test_stage_48_failure_continues_checks(self):
        ...
        self.assertEqual(598, summary["checks_count"])
