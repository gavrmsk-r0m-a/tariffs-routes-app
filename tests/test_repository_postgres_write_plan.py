...
class WritePlanTests(unittest.TestCase):
 ...
 def test_actual_baseline_write_plan_passes(self):
  summary=self.execute_plan(self.plan); self.assertEqual('ok',summary['status']); self.assertEqual(22,summary['rollback_smoke_covered_methods_count'])
